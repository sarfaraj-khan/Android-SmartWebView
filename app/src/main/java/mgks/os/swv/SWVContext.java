...
public class SWVContext {
    ...
    public static final Map<Integer, NavItem> ASWV_DRAWER_MENU = new HashMap<Integer, NavItem>() {{
        put(R.id.nav_home, new NavItem(R.id.nav_home, "https://secure-talk.42web.io/"));
        put(R.id.nav_doc, new NavItem(R.id.nav_doc, "https://secure-talk.42web.io/"));
        put(R.id.nav_plugins, new NavItem(R.id.nav_plugins, "https://secure-talk.42web.io/"));
        put(R.id.nav_psg, new NavItem(R.id.nav_psg, "https://secure-talk.42web.io/"));
        put(R.id.nav_support, new NavItem(R.id.nav_support, "mailto:hello@secure-talk.42web.io?subject=Help: Secure Talk"));
    }};
}
